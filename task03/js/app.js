...
var addr = `http://localhost:8083/list/detail?chapterId=4`;
...
//   else if(urls.pathName == '/getChapterList'){
//     var str = JSON.stringify(chapterList);
//     res.end(str);
// }
//   else if(urls.pathName == '/getDetail'){
//     var chapterId = queryString.parse(urls.query).chapterId;
//     var dataList = [];
...
// }
    ...
    var fileContent = fs.readFile('../.'+req.url,function(err,data){
          res.end(data);
        })
    //  var htmlPath = path.join(__dirname,urls.pathname);
    //     if(urls.pathname.indexOf('js') >= 0){
    //         var htmlContent = fs.readFileSync(htmlPath);
    //         res.writeHead(200,{"Content-Type":"text/javascript"});
    //         res.end(htmlContent);
    //     }
    //     else if(urls.pathname.indexOf('css') >= 0){
    //         var htmlContent = fs.readFileSync(htmlPath);
    //         res.writeHead(200,{"Content-Type":"text/css"});
    //         res.end(htmlContent);
    //     }
    //     else if(urls.pathname.indexOf('png') >= 0){
    //         var htmlContent = fs.readFileSync(htmlPath);
    //         res.writeHead(200,{"Content-Type":"image/png"});
    //         res.end(htmlContent);
    //     }
    //     else if(urls.pathname.indexOf('jpg')>=0 || urls.pathname.indexOf('jpeg')>=0){
    //         var htmlContent = fs.readFileSync(htmlPath);
